...
,p_required_patch=>wwv_flow_imp.id(9645422383445787)
,p_dialog_chained=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9824000960446047)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9824489975446047)
,p_name=>'P10061_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(9824000960446047)
