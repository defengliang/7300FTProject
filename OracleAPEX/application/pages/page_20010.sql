...
,p_group_id=>wwv_flow_imp.id(9847731498446071)
,p_javascript_code_onload=>'apex.pwa.initPushSubscriptionPage();'
,p_step_template=>wwv_flow_imp.id(9358738377445659)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9849314128446073)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9849659124446073)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(9848982976446073)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9850195401446074)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(9849659124446073)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(9850472829446074)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9850943127446074)
,p_event_id=>wwv_flow_imp.id(9850472829446074)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9851425114446074)
,p_event_id=>wwv_flow_imp.id(9850472829446074)
