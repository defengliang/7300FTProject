...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9852915108446076)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_plug_template=>wwv_flow_imp.id(9427956098445690)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9853236847446076)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(9401799841445682)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(9853719046446077)
,p_region_id=>wwv_flow_imp.id(9853236847446076)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9854223047446077)
...
,p_list_id=>wwv_flow_imp.id(9851849502446075)
