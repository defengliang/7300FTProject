...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9551293039445742)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9551587525445742)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9551889577445742)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9552195043445742)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9552493292445742)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9552755586445742)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9553061267445743)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9553387369445743)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9553681250445743)
,p_plugin_id=>wwv_flow_imp.id(9551293039445742)
,p_attribute_scope=>'COMPONENT'
