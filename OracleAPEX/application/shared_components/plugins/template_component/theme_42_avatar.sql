...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9536412533445726)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9536774855445731)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9537005690445732)
,p_plugin_attribute_id=>wwv_flow_imp.id(9536774855445731)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9537414272445733)
,p_plugin_attribute_id=>wwv_flow_imp.id(9536774855445731)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9537892304445733)
,p_plugin_attribute_id=>wwv_flow_imp.id(9536774855445731)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9538292474445733)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9536774855445731)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9538534652445733)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9538292474445733)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9538800753445733)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9539133905445733)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9539464360445733)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9539765656445733)
,p_plugin_attribute_id=>wwv_flow_imp.id(9539464360445733)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9540130070445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9539464360445733)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9540553282445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9539464360445733)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9540974043445734)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9541240780445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9540974043445734)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9541614390445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9540974043445734)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9542011584445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9540974043445734)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9542406726445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9540974043445734)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9542868651445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9540974043445734)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9543294766445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9540974043445734)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9543607942445734)
,p_plugin_attribute_id=>wwv_flow_imp.id(9540974043445734)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9544087236445734)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1809587310960559479)
,p_plugin_id=>wwv_flow_imp.id(9536412533445726)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
