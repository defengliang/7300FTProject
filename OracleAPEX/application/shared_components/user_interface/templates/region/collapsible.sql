...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9413501726445686)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9413802678445686)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9414190390445686)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9414482573445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9414714492445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9415075031445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9415323516445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9415618793445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9415999441445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9416253768445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9416532968445687)
,p_plug_template_id=>wwv_flow_imp.id(9413501726445686)
,p_name=>'Sub Regions'
