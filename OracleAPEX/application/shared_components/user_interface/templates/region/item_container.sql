...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9453558381445697)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9453855990445697)
,p_plug_template_id=>wwv_flow_imp.id(9453558381445697)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9454152329445698)
,p_plug_template_id=>wwv_flow_imp.id(9453558381445697)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9454439734445698)
,p_plug_template_id=>wwv_flow_imp.id(9453558381445697)
,p_name=>'Button Start'
