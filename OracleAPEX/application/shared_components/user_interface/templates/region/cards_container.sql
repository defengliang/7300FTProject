...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9401799841445682)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9402028711445682)
,p_plug_template_id=>wwv_flow_imp.id(9401799841445682)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9402380196445682)
,p_plug_template_id=>wwv_flow_imp.id(9401799841445682)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9402609871445683)
,p_plug_template_id=>wwv_flow_imp.id(9401799841445682)
,p_name=>'Sub Regions'
