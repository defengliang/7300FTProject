...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9431462967445693)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9431793347445693)
,p_plug_template_id=>wwv_flow_imp.id(9431462967445693)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9432003703445693)
,p_plug_template_id=>wwv_flow_imp.id(9431462967445693)
,p_name=>'Sub Regions'
