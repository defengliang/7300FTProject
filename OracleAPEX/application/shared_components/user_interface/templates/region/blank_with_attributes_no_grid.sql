...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9396048426445681)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9396340654445681)
,p_plug_template_id=>wwv_flow_imp.id(9396048426445681)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9396648720445681)
,p_plug_template_id=>wwv_flow_imp.id(9396048426445681)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9396963378445681)
,p_plug_template_id=>wwv_flow_imp.id(9396048426445681)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9397247412445681)
,p_plug_template_id=>wwv_flow_imp.id(9396048426445681)
,p_name=>'Sub Regions'
