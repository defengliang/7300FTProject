...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9471062470445700)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9471397659445700)
,p_plug_template_id=>wwv_flow_imp.id(9471062470445700)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9471681467445700)
,p_plug_template_id=>wwv_flow_imp.id(9471062470445700)
,p_name=>'Tabs'
