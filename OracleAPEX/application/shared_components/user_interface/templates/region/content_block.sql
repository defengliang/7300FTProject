...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9423327020445689)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9423631034445689)
,p_plug_template_id=>wwv_flow_imp.id(9423327020445689)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9423982492445689)
,p_plug_template_id=>wwv_flow_imp.id(9423327020445689)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9424224247445689)
,p_plug_template_id=>wwv_flow_imp.id(9423327020445689)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9424581937445689)
,p_plug_template_id=>wwv_flow_imp.id(9423327020445689)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9424897902445689)
,p_plug_template_id=>wwv_flow_imp.id(9423327020445689)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9425121032445689)
,p_plug_template_id=>wwv_flow_imp.id(9423327020445689)
,p_name=>'Sub Regions'
