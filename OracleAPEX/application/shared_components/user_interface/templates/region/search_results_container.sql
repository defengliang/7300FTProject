...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9458556571445698)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9458874911445698)
,p_plug_template_id=>wwv_flow_imp.id(9458556571445698)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9459113141445698)
,p_plug_template_id=>wwv_flow_imp.id(9458556571445698)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9459463772445698)
,p_plug_template_id=>wwv_flow_imp.id(9458556571445698)
,p_name=>'Sub Regions'
