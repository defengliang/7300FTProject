...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9427956098445690)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9428262742445691)
,p_plug_template_id=>wwv_flow_imp.id(9427956098445690)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9428564115445692)
,p_plug_template_id=>wwv_flow_imp.id(9427956098445690)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9428847727445692)
,p_plug_template_id=>wwv_flow_imp.id(9427956098445690)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9429180357445692)
,p_plug_template_id=>wwv_flow_imp.id(9427956098445690)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9429435283445692)
,p_plug_template_id=>wwv_flow_imp.id(9427956098445690)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
