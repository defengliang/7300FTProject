...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9441499547445695)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9441789631445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9442076498445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9442327536445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9442613948445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9442944513445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9443234767445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9443505917445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9443843171445695)
,p_plug_template_id=>wwv_flow_imp.id(9441499547445695)
,p_name=>'Sub Regions'
