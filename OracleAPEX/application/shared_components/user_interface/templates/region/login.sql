...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9456058184445698)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9456311270445698)
,p_plug_template_id=>wwv_flow_imp.id(9456058184445698)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9456683824445698)
,p_plug_template_id=>wwv_flow_imp.id(9456058184445698)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9456996257445698)
,p_plug_template_id=>wwv_flow_imp.id(9456058184445698)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9457228811445698)
,p_plug_template_id=>wwv_flow_imp.id(9456058184445698)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9457555866445698)
,p_plug_template_id=>wwv_flow_imp.id(9456058184445698)
,p_name=>'Sub Regions'
