...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9374920625445672)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9375284039445672)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9375540756445672)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9375864133445672)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9376145514445672)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9376406261445672)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9376777807445672)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9377031437445673)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9377394646445673)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9377680456445673)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9377928191445673)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9378256399445673)
,p_page_template_id=>wwv_flow_imp.id(9374920625445672)
