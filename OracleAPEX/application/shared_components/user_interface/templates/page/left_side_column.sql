...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9371237285445671)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9371559106445671)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9371829923445671)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9372137959445671)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9372417687445671)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9372763691445671)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9373079947445671)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9373390951445671)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9373669759445672)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9373946709445672)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9374222654445672)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9374569048445672)
,p_page_template_id=>wwv_flow_imp.id(9371237285445671)
